...
print_mem_usage (int *mype)
{
  ...
  fprintf (stderr,
	   "%6d  heap = %10u  %f MB  stack = %10u   %f MB  TOTAL = %f MB\n",
	   *mype, heap_size, ((double) heap_size / 1024.0 / 1024.0),
	   stack_size, ((double) stack_size / 1024.0 / 1024.0),
...
void
print_mem_usage_str (int *mype, char *str)
{
#ifdef __bgq__
  uint64_t heap_size;
  int dummy;
