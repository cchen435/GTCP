...
inline real
abs_min_real (real arg1, real arg2)
{
...
int
chargei (gtc_bench_data_t * gtc_input)
{
...
#pragma omp for
	...
	pgyro_lc[2] = pgyro_lc[3] =
	  radcos_lc * gyrorad_const_mult * gyrorad_const_mult * dtheta_dx;
...
int
chargei_init (gtc_bench_data_t * gtc_input)
{
